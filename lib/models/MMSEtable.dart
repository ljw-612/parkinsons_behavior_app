...
/** This is an auto generated class representing the MMSEtable type in your schema. */
@immutable
class MMSEtable extends Model {
  static const classType = const _MMSEtableModelType();
  final String id;
  final String? _uid;
  ...
  MMSEtable copyWith({String? id, String? uid, String? Question1, String? Question2, String? Question3, String? Question4, String? Question5, String? Question6, String? Question7, String? Question8, String? Question9, String? Question10}) {
    return MMSEtable(
      id: id ?? this.id,
      uid: uid ?? this.uid,
  ...
  MMSEtable.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _uid = json['uid'],
  ...
  static final QueryField ID = QueryField(fieldName: "mMSEtable.id");
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "MMSEtable";
    modelSchemaDefinition.pluralName = "MMSEtables";
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MMSEtable.QUESTION1,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MMSEtable.QUESTION2,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MMSEtable.QUESTION3,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MMSEtable.QUESTION4,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MMSEtable.QUESTION5,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MMSEtable.QUESTION6,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MMSEtable.QUESTION7,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MMSEtable.QUESTION8,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MMSEtable.QUESTION9,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MMSEtable.QUESTION10,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
  });
...
class _MMSEtableModelType extends ModelType<MMSEtable> {
  const _MMSEtableModelType();
  
  @override
  MMSEtable fromJson(Map<String, dynamic> jsonData) {
    return MMSEtable.fromJson(jsonData);
  }
}