...
/** This is an auto generated class representing the MDSUPDRStable type in your schema. */
@immutable
class MDSUPDRStable extends Model {
  static const classType = const _MDSUPDRStableModelType();
  final String id;
  final String? _uid;
  ...
  MDSUPDRStable copyWith({String? id, String? uid, int? Question1, int? Question2, int? Question3, int? Question4, int? Question5, int? Question6, int? Question7, int? Question8, int? Question9, int? Question10, int? Question11, int? Question12, int? Question13, int? Question14, int? Question15, int? Question16, int? Question17, int? Question18, int? Question19, int? Question20, int? Question21, String? SurveyParticipant}) {
    return MDSUPDRStable(
      id: id ?? this.id,
      uid: uid ?? this.uid,
  ...
  MDSUPDRStable.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _uid = json['uid'],
  ...
  static final QueryField ID = QueryField(fieldName: "mDSUPDRStable.id");
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "MDSUPDRStable";
    modelSchemaDefinition.pluralName = "MDSUPDRStables";
    
    modelSchemaDefinition.addField(ModelFieldDefinition.id());
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.UID,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION1,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION2,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION3,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION4,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION5,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION6,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION7,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION8,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION9,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION10,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION11,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION12,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION13,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION14,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION15,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION16,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION17,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION18,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION19,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION20,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.QUESTION21,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: MDSUPDRStable.SURVEYPARTICIPANT,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
  });
...
class _MDSUPDRStableModelType extends ModelType<MDSUPDRStable> {
  const _MDSUPDRStableModelType();
  
  @override
  MDSUPDRStable fromJson(Map<String, dynamic> jsonData) {
    return MDSUPDRStable.fromJson(jsonData);
  }
}